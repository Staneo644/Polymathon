  ...
  return (
    <div className="flex flex-col justify-evenly h-full">
      <div className="flex justify-between mx-10 items-center">
        <Link
          href="https://discord.gg/vfx8VVRV"
          passHref
          className="font-bold font-serif italic"
        >
          Rejoindre notre discord
        </Link>
        <YellowButton
          onClick={() => window.open("https://discord.gg/vfx8VVRV")}
      ...
      <div className="flex justify-between items-center mx-10">
        ...
        <YellowButton
          onClick={() => window.open("mailto:polymathon@proton.me")}
