      ...
      <header className="relative w-full bg-gray-100 p-2 flex justify-between items-center">  
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-8 hidden lg:block">
            <FontAwesomeIcon icon={faHome} className={actualPage == '/' ? buttonTextureLg + "mx-8" : buttonTextureLg + "mx-8"} onClick={() => router.push('/')}/>
            <FontAwesomeIcon icon={faSearch} className={actualPage == '/rechercher' ? buttonTextureLg + "mx-8": buttonTextureLg + "mx-8"} onClick={() => router.push('/rechercher')} />
            <FontAwesomeIcon icon={faPlus} className={actualPage == '/plus-de-mots' ? buttonTextureLg + "mx-8": buttonTextureLg + "mx-8"} onClick={() => router.push('/plus-de-mots')} />
          </div>
